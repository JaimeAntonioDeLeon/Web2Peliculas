...
function MoviePostScreen(){
    ...
    const createCommentAPI = async() =>{
      ...
      const deletePostAPI = async() =>{ //TODO, hacer ue el _id capture el id de la cosa a cambiar
      ...
      const updatePostAPI = async() =>{ //TODO, hacer ue el id capture el id de la cosa a cambiar
    ...
    return(
        <div className='movieListScreen'>
            ...
            <Row xs={12} >
                ...
                <Col xs={8}>
                        <Row><h2>Post Title</h2> </Row>
                        <Row><h4>Movie Subject</h4> </Row>
                        <Row><p> Post description </p></Row>
                </Col>
                ...
                <form onSubmit={submitHandler}>
                    <Row className='mb-4'>Comments</Row>
                    <Row className='m-3'> <h5>Write a comment:</h5><Form.Control
          placeholder="Leave a comment here"
          style={{ backgroundColor:'black' }}
          ref={bodyRef}
        /></Row>
                    <Row xs={12} className='mb-3'><Col xs={2}><button type='submit'>Submit</button></Col></Row>
                    </form>
                    <Row>
                        <Col xs={1}>
                            <img style={{width:100, lenght: 100}} src= "https://static.vecteezy.com/system/resources/previews/000/574/215/non_2x/vector-sign-of-user-icon.jpg"></img>

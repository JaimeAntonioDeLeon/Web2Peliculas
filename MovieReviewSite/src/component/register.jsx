      ...
      <div className='mainBackground'>
        <div className='container'>
           <form onSubmit={submitHandler}>
            ...
            <br />
            <input placeholder="Nombre de usuario" type="text" ref={usernameRef}/>
            <br />
            <input placeholder="contrasena" type="text" ref={passwordRef}/>
            <br />
            {wrongRegister?<p className="errorText">Error: Usuario ya existente!</p>:<p></p>}
            {faltanDatos && <p className="errorText">Falta llenar campos!</p>}
            <button onClick={funci} type="submit">Registrar</button>
            </form>
            {/* <p>Submit Value: <b>{userName}</b> <b>{password}</b> <b>{email}</b></p> */}
            <Link id="registerLink" to="/login"> Ya tienes cuenta?</Link>
        </div>
        </div>
        </div>
    );
